...
public class ItemRFCapacitor3 extends ItemRF {
    ...
    public void registerItemModel() {
	    ModelLoader.setCustomModelResourceLocation(ModItems.itemcapacitorTier3RF, 0, new ModelResourceLocation(ModItems.itemcapacitorTier3RF.getRegistryName(), "inventory"));
	}
	@Override
    ...
    {
		tooltip.add(ChatFormatting.GRAY + I18n.format("Tier 3") );
