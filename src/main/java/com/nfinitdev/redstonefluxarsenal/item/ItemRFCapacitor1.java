...
public class ItemRFCapacitor1 extends ItemRF {
    ...
    {
		tooltip.add(ChatFormatting.GRAY + I18n.format("Tier 1") );
    ...
    public void registerItemModel() {
	    ModelLoader.setCustomModelResourceLocation(ModItems.itemcapacitorRF, 0, new ModelResourceLocation(ModItems.itemcapacitorRF.getRegistryName(), "inventory"));
	}
